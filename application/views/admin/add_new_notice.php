        ...
        <div class="col-sm-12 col-xs-12">
            ...
            <div class="row">
                <div class="col-sm-6 col-xs-12">
                    <div class="demo-box">
                        <form action="<?php echo base_url('admin/add-notice-action'); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea placeholder="Notice Details Here" name="notice_details" value="<?php // echo $notice->notice_details;    ?>" class="form-control"></textarea>                                
                            ...
                            <div class="form-group">
                                ...
                                <input type="checkbox" name="add_to_breaking_news" value="1">
                            </div>
